...
<script>
    ...
    function generate() {
        ...
        if (style.length > 0) {
            ...
            if (!$("#style_variant_checked").prop("checked")) activeOptions.push(style); activeVariants.style = true;
            if (!$("#color_variant_checked").prop("checked")) activeOptions.push(color); activeVariants.color = true;
            if (!$("#size_variant_checked").prop("checked")) activeOptions.push(size); activeVariants.size = true;
    ...
    function applyVariantFilter() {
        ...
        varianttmp.forEach((e) => {
            if ((filter[0] === "All" || filter[0] === e.option1.trim()) &&
                ...
                if(e.option3==""){
                    e.price = cenvertPricefromSize(priceedit, e.option2.trim())
...
<script>
    ...
    function renderAttributes(response) {
        ...
        const defaultAttributes = json.product.selectedAttributes
