<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control input-solid" id="api_key"
                   name="api_key" placeholder="@lang('Api Key')" value="{{ $edit ? $user->api_key : '' }}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label for="private_seller">@lang('Prive price')</label>
            <select class="form-control input-solid" name="private_seller" id="private_seller">
                <option value="1" {{$edit?($user->private_seller==1?'selected':''):''}}>Private</option>
                <option value="0" {{$edit?($user->private_seller==0?'selected':''):''}}>Nomal</option>
            </select>
