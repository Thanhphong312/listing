<tr>
    ...
    <td class="align-middle">
        <a href="./impersonate/take/{{ $user->id }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Impersonate User">
            {{ $user->role->name }} </a>
    </td>
    ...
    <td class="align-middle">
        <span cclass="badge bg-{{ $user->present()->labelClass }} text-light">
