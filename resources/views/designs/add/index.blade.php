                    ...
                    <div id="one_ds" class="col-12 row m-2 border-light">
                        <div class="col-12 row m-2">
                            <div class="col-12" style="padding: 0 12px 0 0;">
                                ...
                                <input class="form-control" type="file" name="file_front" id="file_front" value="">
                            </div>
                        </div>
                        <div class="col-12 row m-2">
                            <div class="col-12" style="padding: 0 12px 0 0;">
                                <label for="file_back">Back</label>
                                <input class="form-control" type="file" name="file_black" id="file_back" value="">
                            </div>
                        </div>
                        <div class="col-12 row m-2">
                            <div class="col-12" style="padding: 0 12px 0 0;">
                                <label for="file_sleeve_left">Sleeve Left</label>
                                <input class="form-control" type="file" name="file_sleeve_left" id="file_sleeve_left" value="">
                            </div>
                        </div>
                        <div class="col-12 row m-2">
                            <div class="col-12" style="padding: 0 12px 0 0;">
                                <label for="file_sleeve_right">Sleeve Right</label>
                                <input class="form-control" type="file" name="file_sleeve_right" id="file_sleeve_right" value="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 row">
                            ...
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    ...
                                    <input class="form-control" type="file" name="file_front_bl" id="file_front_bl">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_back_bl">Back</label>
                                    <input class="form-control" type="file" name="file_back_bl" id="file_back_bl" value="">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_sleeve_left_bl">Sleeve Left</label>
                                    <input class="form-control" type="file" name="file_sleeve_left_bl" id="file_sleeve_left_bl" value="">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_sleeve_right_bl">Sleeve Right</label>
                                    <input class="form-control" type="file" name="file_sleeve_right_bl" id="file_sleeve_right_bl" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 row">
                            ...
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    ...
                                    <input class="form-control" type="file" name="file_front_wt" id="file_front_wt" value="">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_back_wt">Back</label>
                                    <input class="form-control" type="file" name="file_back_wt" id="file_back_wt" value="">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_sleeve_left_wt">Sleeve Left</label>
                                    <input class="form-control" type="file" name="file_sleeve_left_wt" id="file_sleeve_left_wt" value="">
                                </div>
                            </div>
                            <div class="col-12 row m-2">
                                <div class="col-12" style="padding: 0 12px 0 0;">
                                    <label for="file_sleeve_right_wt">Sleeve Right</label>
                                    <input class="form-control" type="file" name="file_sleeve_right_wt" id="file_sleeve_right_wt" value="">
                                </div>
                            </div>
                        </div>
                    </div>
