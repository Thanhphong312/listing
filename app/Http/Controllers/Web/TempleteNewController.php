...
class TempleteNewController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('templetes.index2', compact('templetes','role','user'));
    }
    public function add(Request $request)
    {
        ...
        return view('templetes.add.index2', compact('categories', 'categorietemps', 'user', 'role', 'sizecharts'));
    }
    public function edit(Request $request, $id)
    {
        ...
        return view('templetes.edit.index2', compact('categorietemps', 'categories', 'sizecharts', 'encodedJson', 'templetes', 'breadcrumb', 'category_id','name'));
    }
