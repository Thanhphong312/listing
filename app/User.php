...
class User extends Authenticatable implements TwoFactorAuthenticatableContract, MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'api_key','private_seller','parent_id', 'group_id', 'send_notice'
    ];
    ...
    {
        return $this->role_id == Role::ROLE_SELLER_ID;
    }
    ...
    {
        return $this->role_id == Role::ROLE_USER_ID;
    }
    ...
    {
        return $this->role_id == Role::ROLE_SUPPLIER_ID;
    }
    ...
    {
        return $this->role_id == Role::ROLE_STAFF_ID;
    }
    public function isSupport()
    {
        return $this->role_id == Role::ROLE_SUPPORT_ID;
    }
    public function roles()
    {
        return $this->belongsTo('Vanguard\Role', 'role_id');
    }
