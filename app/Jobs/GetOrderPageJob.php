...
class GetOrderPageJob implements ShouldQueue
{
     ...
     */
    public function __construct($user_id,$store_id, $token, $page, $requestData)
    {
        ...
        try {
            ...
            if ($reportResponse->successful()) {
                ...
                foreach ($responseData['orders'] as $orderData) {
                    ...
                    // Log::info('GetOrderPageJob: API request successful');
                    // Log::info($orderData);
